...
export const homeSevenHeroImages = [
  {
		id: 1,
		...
		image: {
			mobile: {
				url: "/assets/images/hero/banner-mobile-8.webp",
				width: 690,
				height: 480,
			},
			desktop: {
				url: "/assets/images/hero/banner-8.webp",
				width: 1800,
				height: 800,
			},
		},
	...
	},
  {
		...
		image: {
			mobile: {
				url: "/assets/images/hero/banner-mobile-7.webp",
				width: 690,
				height: 480,

			},
			desktop: {
				url: "/assets/images/hero/banner-7.webp",
				width: 1800,
				height: 800,
			},
		},
...
export const Catigory = [

  {
    ...
    title: "Nike Bag",
    slug: "sale-offer",
    description:"Rolex’s powerhouse calibre 3235 Perpet...",
    price:16.38,
    image: {
  ...
  },
  {
    ...
    price:16.00,
    description:"Casual wear (casual attire or clothing) ...",
    image: {
  ...
  },
  {
    ...
    price:16.38,
    slug: "new-sports",
    description:"Footwear refers to garments worn on ...",
    image: {
  ...
  },
  {
    ...
    slug: "new-sports",
    price:720.00,
    description:"Polarized sunglasses reduce glare ref ...",
    image: {
...
export const contomSevenHeroImages = [
  {
		id: 1,
		title: "We picked every item with care you must try",
		slug: "winter-collection",
		image: {
			...
			desktop: {
				url: "/assets/images/Contom/1.webp",
				width: 1800,
				height: 800,
			},
		},
	},
  {
		...
		image: {
			...
			desktop: {
				url: "/assets/images/Contom/2.webp",
				width: 1800,
				height: 800,
			},
		},
	},
  {
		...
		image: {
			...
			desktop: {
				url: "/assets/images/Contom/3.webp",
				width: 1800,
				height: 800,
			},
		},
